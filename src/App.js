  ...
  return (
    <Router>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">D-TROY!</a>
...
function Topics() {
  ...
  return (
    <div>
      ...
      <ul>
      <li>
          <Link to={`${url}/Sangonomiya Kokomi`}>Nama</Link>
        </li>
        <li>
          <Link to={`${url}/Kokomi@gmail.com`}>Email</Link>
        </li>
        <li>
          <Link to={`${url}/Username: SangonomiyaKokomi`}>GitHub</Link>
        </li>
      </ul>
...
function ProtectedPage() {
  return (
    <div>
      ...
      <hr />
      <h1 class="text-center">D-TROY!</h1>
      <br />
      <br />
      <br />
      <br />
